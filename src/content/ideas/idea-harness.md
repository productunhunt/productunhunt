...
seoTitle: Fantasy football for startup founders
...
status: unbuilt
featured: false
editorStamp: The only idea on this site that nearly invented this site. Filed with professional discomfort.
tags:
  - AI nonsense
  - Marketplace
draft: false
...
Most startup idea generators work in a vacuum. You ask for twenty SaaS ideas and receive: AI meeting summarizer, AI invoice assistant, AI CRM, AI workout planner, AI tool for dentists.

Very good. You have successfully generated LinkedIn.
...
Underneath the nonsense sat an insight I still believe.

People do not need more startup ideas. They need help finding the intersection of what they know, what they can access, and what they can realistically execute. A boring idea with strong founder-context fit beats a brilliant idea generated without context. A generic model says "build AI for legal workflows"; Idea Harness says "your spouse runs a small legal practice, you know document automation, and five lawyers you can name all complain about the same filing workflow." That is not an idea. That is a starting point.

Even the marketplace had a defensible core: a graveyard with asking prices, where the tombstones include honest cause of death. Which, in retrospect, may have been the conceptual ancestor of the website you are currently reading.
...
The product evolved from "help people discover ideas uniquely suited to them" into "rank your imaginary company against other imaginary companies, and when sanity returns, sell the idea to someone with worse judgment." The personalized generation was the strongest part and never needed the rest. The rest was Fantasy Premier League for founders, except the players don't exist either.

## Unwanted Bonus

**Idea Futures.** The obvious next layer: a derivatives market on the leaderboard. Go long on a stranger's compliance SaaS. Short the AI meeting summarizer at #2. When an idea stays unbuilt past its strike date, the shorts collect. Eventually nobody generates ideas at all — the real money is in trading volatility on other people's abandoned ambitions, and the top of the leaderboard is a market maker who has never had an idea in his life.
